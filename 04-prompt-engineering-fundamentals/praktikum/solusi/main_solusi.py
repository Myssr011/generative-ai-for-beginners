"""KUNCI JAWABAN — Praktikum 04 Prompt Engineering Fundamentals.

File ini berisi keempat TODO yang SUDAH LENGKAP, sebagai rujukan.
Cara pakai yang disarankan:
  1. Coba kerjakan sendiri dulu TODO di src/main.py (pakai petunjuk bertahap
     di PRAKTIKUM.html).
  2. Mentok? Buka file ini, pahami barisnya, lalu tulis ulang dengan
     pengertianmu sendiri — jangan asal salin.

Untuk menguji file ini langsung:
    cp solusi/main_solusi.py src/main.py     # menimpa versi TODO-mu!
    python src/main.py
"""
import os
...
# ─────────────────────────────────────────────────────────────
# TODO 2: Prompt tunggal via /api/generate — JAWABAN
# ─────────────────────────────────────────────────────────────
def generate(prompt: str) -> str:
    ...
    r = requests.post(
        ...
        json={
            "model": MODEL,
            "prompt": prompt,
            "stream": False,   # tanpa ini, server mengirim jawaban sepotong-sepotong
        },
        timeout=TIMEOUT,
    )
...
# ─────────────────────────────────────────────────────────────
# TODO 3: Percakapan multi-role via /api/chat — JAWABAN
# ─────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────
# TODO 4: Menyusun prompt few-shot — JAWABAN
# ─────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────
# Demo — sama persis dengan src/main.py, tidak perlu diubah
# ─────────────────────────────────────────────────────────────
