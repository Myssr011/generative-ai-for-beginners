"""Uji jawaban praktikum pertemuan 07. Jalankan dari folder praktikum/:  pytest -q"""
import pytest
import requests
...
def test_generate_model_mengembalikan_tuple():
    jawaban, durasi = _panggil_server(
        main.generate_model, "smollm2:135m", "Say one color. One word only."
    )
